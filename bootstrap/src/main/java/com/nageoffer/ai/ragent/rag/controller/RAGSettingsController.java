...
public class RAGSettingsController {
    ...
    private MemorySettings toMemorySettings(MemoryProperties props) {
        return MemorySettings.builder()
                ...
                .hybridEnabled(props.getHybridEnabled())
                .recentKeepMessages(props.getRecentKeepMessages())
                .importantMessageThreshold(props.getImportantMessageThreshold())
                .summaryMaxSourceMessages(props.getSummaryMaxSourceMessages())
                .tokenTriggerThreshold(props.getTokenTriggerThreshold())
                .stageSwitchTriggerEnabled(props.getStageSwitchTriggerEnabled())
                .recoveryTriggerEnabled(props.getRecoveryTriggerEnabled())
