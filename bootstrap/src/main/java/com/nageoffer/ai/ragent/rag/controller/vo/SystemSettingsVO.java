...
public class SystemSettingsVO {
    ...
    public static class MemorySettings {
        ...
        private Integer recentKeepMessages;
        private Integer importantMessageThreshold;
        private Integer summaryMaxSourceMessages;
        private Integer tokenTriggerThreshold;
        private Boolean stageSwitchTriggerEnabled;
        private Boolean recoveryTriggerEnabled;
